...
snarkjs groth16 setup ./circom/eth_block.r1cs ./circom/ptau/pot12_final.ptau ./circom/zkey/eth_block_final.zkey

# Generate reference zkey
snarkjs zkey new ./circom/eth_block.r1cs ./circom/ptau/pot12_final.ptau ./circom/zkey/eth_block_0000.zkey
...
#  Verify zkey
snarkjs zkey verify ./circom/eth_block.r1cs ./circom/ptau/pot12_final.ptau ./circom/zkey/eth_block_0003.zkey
...
snarkjs zkey verify ./circom/eth_block.r1cs ./circom/ptau/pot12_final.ptau ./circom/zkey/eth_block_final.zkey
